...
BEGIN_MESSAGE_MAP(XComboList, CWnd)
	//{{AFX_MSG_MAP(XComboList)
	ON_WM_LBUTTONUP()
	ON_WM_KILLFOCUS()
	ON_WM_CREATE()
	ON_WM_VSCROLL()
...
///////////////////////////////////////////////////////////////////////////////
// ctor
XComboList::XComboList(CWnd *pParent)
{
	m_pParent = pParent;
	ASSERT(m_pParent);
	m_nCount = 0;
...
XComboList::~XComboList()
{
}

///////////////////////////////////////////////////////////////////////////////
// SetActive
void XComboList::SetActive(int nScrollBarWidth)
{
	//TRACE0("in XComboList::SetActive\n");
...
///////////////////////////////////////////////////////////////////////////////
// GetScrollBarCtrl
CScrollBar* XComboList::GetScrollBarCtrl(int nBar)
{
	UNUSED_ALWAYS(nBar);
	return &m_wndSBVert;
}
...
void XComboList::SendRegisteredMessage(UINT nMsg, WPARAM wParam, LPARAM lParam)
{
	CWnd *pWnd = m_pParent;
	if (pWnd)
...
///////////////////////////////////////////////////////////////////////////////
// OnLButtonDown
void XComboList::OnLButtonUp(UINT nFlags, CPoint point) 
{
...
///////////////////////////////////////////////////////////////////////////////
// PreTranslateMessage
BOOL XComboList::PreTranslateMessage(MSG* pMsg) 
{
	switch (pMsg->message)
	{
		case WM_KEYDOWN:
...
///////////////////////////////////////////////////////////////////////////////
// OnKillFocus
void XComboList::OnKillFocus(CWnd* pNewWnd) 
{
	//TRACE0("in XComboList::OnKillFocus\n");
...
///////////////////////////////////////////////////////////////////////////////
// OnCreate
int XComboList::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
///////////////////////////////////////////////////////////////////////////////
// OnVScroll
void XComboList::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar*) 
{
	if (!::IsWindow(m_ListBox.m_hWnd))
		return;

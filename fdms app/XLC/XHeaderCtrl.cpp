...
IMPLEMENT_DYNCREATE(XHeaderCtrl, CHeaderCtrl)
...
///////////////////////////////////////////////////////////////////////////////
// ModifyProperty
BOOL XHeaderCtrl::ModifyProperty(WPARAM wParam, LPARAM lParam)
{
	switch(wParam)
	{
...
///////////////////////////////////////////////////////////////////////////////
// DrawCtrl
void XHeaderCtrl::DrawCtrl(CDC* pDC)
{
	CRect rectClip;
	...
	CFont boldfont; boldfont.m_hObject = 0;
...
///////////////////////////////////////////////////////////////////////////////
// DrawItem
void XHeaderCtrl::DrawItem(LPDRAWITEMSTRUCT)
{
...
///////////////////////////////////////////////////////////////////////////////
// DrawItem
void XHeaderCtrl::DrawItem(CDC* pDC, CRect rect, LPHDITEM lphdi)
{
...
///////////////////////////////////////////////////////////////////////////////
// DrawImage
int XHeaderCtrl::DrawImage(CDC* pDC, CRect rect, LPHDITEM lphdi, BOOL bRight)
{
...
///////////////////////////////////////////////////////////////////////////////
// DrawBitmap
int XHeaderCtrl::DrawBitmap(CDC* pDC, 
								CRect rect, 
								LPHDITEM lphdi, 
								CBitmap* pBitmap, 
								BITMAP* pBitmapInfo, 
...
///////////////////////////////////////////////////////////////////////////////
// DrawText
int XHeaderCtrl::DrawText(CDC* pDC, CRect rect, LPHDITEM lphdi)
{
	CSize size;
...
///////////////////////////////////////////////////////////////////////////////
// OnInsertItem
LRESULT XHeaderCtrl::OnInsertItem(WPARAM, LPARAM)
{
	return Default();
}
...
///////////////////////////////////////////////////////////////////////////////
// OnDeleteItem
LRESULT XHeaderCtrl::OnDeleteItem(WPARAM, LPARAM)
{
	return Default();
}
...
///////////////////////////////////////////////////////////////////////////////
// OnSetImageList
LRESULT XHeaderCtrl::OnSetImageList(WPARAM, LPARAM lParam)
{
...
///////////////////////////////////////////////////////////////////////////////
// OnLayout
LRESULT XHeaderCtrl::OnLayout(WPARAM, LPARAM lParam)
{
...
///////////////////////////////////////////////////////////////////////////////
// OnSysColorChange
void XHeaderCtrl::OnSysColorChange() 
{
	TRACE(_T("in XHeaderCtrl::OnSysColorChange\n"));
...
///////////////////////////////////////////////////////////////////////////////
// OnEraseBkgnd
BOOL XHeaderCtrl::OnEraseBkgnd(CDC* pDC) 
{
	UNUSED_ALWAYS(pDC);
	return TRUE;
}

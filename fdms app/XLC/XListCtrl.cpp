...
// if XListCtrl is created via Create() instead of via dialog template.
//
...
#endif
	//ON_REGISTERED_MESSAGE(WM_XCAL_VK_ESCAPE, OnComboEscape)
	//ON_REGISTERED_MESSAGE(WM_XCAL_VK_RETURN, OnComboReturn)
	//ON_REGISTERED_MESSAGE(WM_XCAL_KEYDOWN, OnComboKeydown)
	//ON_REGISTERED_MESSAGE(WM_XCAL_LBUTTONUP, OnComboLButtonUp)
END_MESSAGE_MAP()
...
///////////////////////////////////////////////////////////////////////////////
// PreSubclassWindow
void XListCtrl::PreSubclassWindow()
{
...
///////////////////////////////////////////////////////////////////////////////
// OnCreate
int XListCtrl::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// When the XListCtrl object is created via a call to Create(), instead
...
///////////////////////////////////////////////////////////////////////////////
// SubclassHeaderControl
void XListCtrl::SubclassHeaderControl()
{
...
///////////////////////////////////////////////////////////////////////////////
// OnClick
BOOL XListCtrl::OnClick(NMHDR*, LRESULT* pResult)
{
#ifndef DO_NOT_INCLUDE_XCOMBOLIST
	UnpressComboButton();
#endif
...
#endif
		else if (pXLCD && (pXLCD[nSubItem].nCheckedState != -1)  && (pXLCD[nSubItem].nCheckedState < 2))
		{
...
///////////////////////////////////////////////////////////////////////////////
// DrawProgress
void XListCtrl::DrawProgress(int nItem,
							  int nSubItem,
							  CDC *pDC,
							  COLORREF crText,
							  COLORREF crBkgnd,
...
///////////////////////////////////////////////////////////////////////////////
// DrawComboBox
void XListCtrl::DrawComboBox(int nItem,
							  int nSubItem,
							  CDC *pDC,
							  COLORREF crText,
							  COLORREF crBkgnd,
							  ...
							  XLISTCTRLDATA *pXLCD)
{
	...
	else
	{
		...
		if (!m_pListBox)
		{
			...
			m_pListBox = new XComboList(this);
			ASSERT(m_pListBox);
...
///////////////////////////////////////////////////////////////////////////////
// DrawCheckbox
void XListCtrl::DrawCheckbox(int nItem,
							  int nSubItem,
							  CDC *pDC,
							  COLORREF crText,
							  COLORREF crBkgnd,
...
///////////////////////////////////////////////////////////////////////////////
// GetDrawColors
void XListCtrl::GetDrawColors(int nItem,
							   int nSubItem,
							   COLORREF& colorText,
							   COLORREF& colorBkgnd)
{
...
///////////////////////////////////////////////////////////////////////////////
// DrawImage
int XListCtrl::DrawImage(int nItem,
						  int nSubItem,
						  CDC* pDC,
						  COLORREF crText,
						  COLORREF crBkgnd,
...
///////////////////////////////////////////////////////////////////////////////
// DrawText
void XListCtrl::DrawText(int nItem,
						  int nSubItem,
						  CDC *pDC,
						  COLORREF crText,
						  COLORREF crBkgnd,
...
///////////////////////////////////////////////////////////////////////////////
// GetSubItemRect
BOOL XListCtrl::GetSubItemRect(int nItem,
								int nSubItem,
								int nArea,
								CRect& rect)
{
...
///////////////////////////////////////////////////////////////////////////////
// OnLButtonDown
void XListCtrl::OnLButtonDown(UINT nFlags, CPoint point)
{
	TRACE(_T("in XListCtrl::OnLButtonDown\n"));
...
#endif
			else if (pXLCD[nSubItem].bDateTime)
			{
			}
		}
	}
...
///////////////////////////////////////////////////////////////////////////////
// InsertItem
int XListCtrl::InsertItem(const LVITEM* pItem)
{
...
///////////////////////////////////////////////////////////////////////////////
// InsertItem
int XListCtrl::InsertItem(int nItem, LPCTSTR lpszItem)
{
	ASSERT(nItem >= 0);
	if (nItem < 0)
		return -1;
...
///////////////////////////////////////////////////////////////////////////////
// InsertItem
int XListCtrl::InsertItem(int nItem,
						   LPCTSTR lpszItem,
						   COLORREF crText,
...
///////////////////////////////////////////////////////////////////////////////
// SetItem
int XListCtrl::SetItem(const LVITEM* pItem)
{
	ASSERT(pItem->iItem >= 0);
	if (pItem->iItem < 0)
		return -1;
...
///////////////////////////////////////////////////////////////////////////////
// SetItemImage
BOOL XListCtrl::SetItemImage(int nItem, int nSubItem, int nImage, COLORREF crBackground)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
	...
	if (pXLCD)
	{
		...
		// update background color field flag
...
///////////////////////////////////////////////////////////////////////////////
// SetItemImage
BOOL XListCtrl::SetItemImage(int nItem, int nSubItem, int nImage)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetItemText
BOOL XListCtrl::SetItemText(int nItem, int nSubItem, LPCTSTR lpszText)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// DeleteItem
BOOL XListCtrl::DeleteItem(int nItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
//
BOOL XListCtrl::SetProgress(int nItem,
							 int nSubItem,
...
///////////////////////////////////////////////////////////////////////////////
// DeleteProgress
void XListCtrl::DeleteProgress(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// UpdateProgress
void XListCtrl::UpdateProgress(int nItem, int nSubItem, int nPercent)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// Set
BOOL XListCtrl::SetImageX(int nItem, int nSubItem, int nCheckedState)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
	...
	SetItemImage(nItem, nSubItem, nCheckedState);
...
///////////////////////////////////////////////////////////////////////////////
// SetCheckbox
BOOL XListCtrl::SetCheckbox(int nItem, int nSubItem, int nCheckedState)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// GetCheckbox
int XListCtrl::GetCheckbox(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
//
BOOL XListCtrl::GetEnabled(int nItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetEnabled
BOOL XListCtrl::SetEnabled(int nItem, BOOL bEnable)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetBackground
BOOL XListCtrl::SetBackground(int nItem, int nSubItem, COLORREF crBackground)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// SetBold
BOOL XListCtrl::SetBold(int nItem, int nSubItem, BOOL bBold)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// GetBold
BOOL XListCtrl::GetBold(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
//
BOOL XListCtrl::SetComboBox(int nItem,
							 int nSubItem,
							 BOOL bEnableCombo,
							 CStringArray *psa,
		...
		if (pXLCD[nSubItem].psa)
		{
				...
				(pXLCD[nSubItem].psa->GetSize() > pXLCD[nSubItem].nInitialComboSel))
			{
				...
				if (hue == -1)
					...
					SetItemText(nItem, nSubItem, str, -1, hue);
			}
		}
	}
...
//
CString	XListCtrl::GetComboText(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
void XListCtrl::SelectAll(bool on)
{
...
///////////////////////////////////////////////////////////////////////////////
// SetCurSel
BOOL XListCtrl::SetCurSel(int nItem)
{
	if (nItem < 0)
		return SetItemState(GetCurSel(), 0,
...
///////////////////////////////////////////////////////////////////////////////
// UpdateSubItem
void XListCtrl::UpdateSubItem(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
// Note:  SetItemText may also be used to set the initial combo selection.
//
BOOL XListCtrl::SetCalCtrl(int nItem, int nSubItem, COleDateTime oTime, const CString& lpszText, COLORREF hue)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
	...
	// update flag
	pXLCD[nSubItem].bDateTime = 1;
	pXLCD[nSubItem].oDateTime = oTime;

	if (hue == -1)
		SetItemText(nItem, nSubItem, lpszText);
	else
		SetItemText(nItem, nSubItem, lpszText, -1, hue);
	UpdateSubItem(nItem, nSubItem);
...
//
DWORD XListCtrl::GetItemData(int nItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
COleDateTime XListCtrl::GetDateTime(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
	...
	return pXLCD[nSubItem].oDateTime;
}

///////////////////////////////////////////////////////////////////////////////
// SetItemData
BOOL XListCtrl::SetItemData(int nItem, DWORD dwData)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
//     2 = checked
//
int XListCtrl::GetHeaderCheckedState(int nSubItem)
{
	ASSERT(nSubItem >= 0);
	ASSERT(nSubItem < GetColumns());
	if ((nSubItem < 0) || nSubItem >= GetColumns())
...
LPARAM XListCtrl::GetColumnLPARAM(int nSubItem)
{
	ASSERT(nSubItem >= 0);
	ASSERT(nSubItem < GetColumns());
	if ((nSubItem < 0) || nSubItem >= GetColumns())
	...
	hditem.mask = HDI_LPARAM | HDI_FORMAT | HDI_LPARAM;;
	m_HeaderCtrl.GetItem(nSubItem, &hditem);
...
BOOL XListCtrl::SetHeaderCheckedState(int nSubItem, int nCheckedState)
{
	ASSERT(nSubItem >= 0);
	ASSERT(nSubItem < GetColumns());
	if ((nSubItem < 0) || nSubItem >= GetColumns())
...
///////////////////////////////////////////////////////////////////////////////
// OnColumnClick
BOOL XListCtrl::OnColumnClick(NMHDR* pNMHDR, LRESULT* pResult)
{
	...
	m_HeaderCtrl.SetCurSel(nSubItem);

	// 0 = no checkbox
	if (nCheckedState != XHEADERCTRL_NO_IMAGE)
	{
		nCheckedState = (nCheckedState == XHEADERCTRL_UNCHECKED_IMAGE) ? XHEADERCTRL_CHECKED_IMAGE : XHEADERCTRL_UNCHECKED_IMAGE;
...
///////////////////////////////////////////////////////////////////////////////
// CountCheckedItems
int XListCtrl::CountCheckedItems(int nSubItem)
{
	ASSERT(nSubItem >= 0);
	ASSERT(nSubItem < GetColumns());
	if ((nSubItem < 0) || nSubItem >= GetColumns())
...
///////////////////////////////////////////////////////////////////////////////
// OnSysColorChange
void XListCtrl::OnSysColorChange()
{
	TRACE(_T("in XListCtrl::OnSysColorChange\n"));
...
///////////////////////////////////////////////////////////////////////////////
// UnpressComboButton
void XListCtrl::UnpressComboButton()
{
...
//
void XListCtrl::OnTimer(UINT nIDEvent)
{
		...
		if (m_pListBox)
		{
			...
			if (i != LB_ERR)
			{
				...
				if ((m_nComboItem >= 0 && m_nComboItem < GetItemCount()) &&
					(m_nComboSubItem >= 0 && m_nComboSubItem < GetColumns()))
				{
					SetItemText(m_nComboItem, m_nComboSubItem, str, -1, WHITE);
...
///////////////////////////////////////////////////////////////////////////////
// OnComboEscape
LRESULT XListCtrl::OnComboEscape(WPARAM, LPARAM)
{
	KillTimer(1);
	SetTimer(2, 50, NULL);
...
///////////////////////////////////////////////////////////////////////////////
// OnComboReturn
LRESULT XListCtrl::OnComboReturn(WPARAM, LPARAM)
{
	TRACE(_T("in XListCtrl::OnComboReturn\n"));
	KillTimer(1);
	SetTimer(3, 50, NULL);
	return 0;
}
...
///////////////////////////////////////////////////////////////////////////////
// OnComboLButtonUp
LRESULT XListCtrl::OnComboLButtonUp(WPARAM, LPARAM)
{
	TRACE(_T("in XListCtrl::OnComboLButtonUp\n"));
	KillTimer(1);
	SetTimer(3, 50, NULL);
	return 0;
}
...
///////////////////////////////////////////////////////////////////////////////
// OnComboKeydown
LRESULT XListCtrl::OnComboKeydown(WPARAM, LPARAM)
{
	SetTimer(4, 50, NULL);
	return 0;
}
...
///////////////////////////////////////////////////////////////////////////////
// OnToolHitTest
int XListCtrl::OnToolHitTest(CPoint point, TOOLINFO * pTI) const
{
...
///////////////////////////////////////////////////////////////////////////////
// OnToolTipText
BOOL XListCtrl::OnToolTipText(UINT /*id*/, NMHDR * pNMHDR, LRESULT * pResult)
{
	UINT nID = pNMHDR->idFrom;
	//TRACE(_T("in XListCtrl::OnToolTipText: id=%d\n"), nID);
	...
	*pResult = 0;
	...
	if (nFlags & LVHT_ONITEMLABEL)
	{
		...
		if (!strToolTip.IsEmpty())
		{
			...
			size_t szt = strToolTip.GetLength();
			if (szt <= 80)
			{
#ifndef _UNICODE
			...
			//else
			//{
			//	GetParent()->SendMessage( MY_BIGFATTOOLTIP, nItem, (LPARAM)(strToolTip.GetBuffer()) );
			//}
...
///////////////////////////////////////////////////////////////////////////////
// SetItemToolTipText
BOOL XListCtrl::SetItemToolTipText(int nItem, int nSubItem, LPCTSTR lpszToolTipText)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
...
///////////////////////////////////////////////////////////////////////////////
// GetItemToolTipText
CString XListCtrl::GetItemToolTipText(int nItem, int nSubItem)
{
	CString strToolTip;
	strToolTip = _T("");
...
///////////////////////////////////////////////////////////////////////////////
// DeleteAllToolTips
void XListCtrl::DeleteAllToolTips()
{
...
CEdit* XListCtrl::EditSubLabel( int nItem, int nCol )
{
	...
	if( nCol >= nColumnCount || GetColumnWidth(nCol) < 1 )
		return NULL;

	if (!(GetColumnWriteFlag(nCol)))
	{
		// If accessibility is specified and it is found false, then it is RO
		return NULL;  // this cell is readonly ....
	}

	// Get the column offset
	int offset = 0;  // jfl hack todo: negative offset due to check box bitmap expansion
	...
	rect.left += offset;//+4;
	rect.right = rect.left + GetColumnWidth( nCol ) - 0 ;
...
void XListCtrl::OnEndLabelEdit(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void XListCtrl::OnLButtonDblClk(UINT nFlags, CPoint point)
{
	...
	if( ( index = HitTestEx( point, &colnum )) != -1 )
	{
		...
		if( (GetItemState( index, flag ) & flag) == flag)
		{
			...
			XLISTCTRLDATA *pXLCD = (XLISTCTRLDATA *) CListCtrl::GetItemData(index);
			if (!pXLCD)
			{
				return;
			}
			...
			bool rw = GetColumnWriteFlag(colnum);
			if ((pXLCD[colnum].bDateTime) && 
				(rw) &&
				( GetWindowLong(m_hWnd, GWL_STYLE) & LVS_EDITLABELS ))
			{
				GetParent()->SendMessage( MY_BOX_DBLCLICK, index, 
					colnum );
			}
		}
		else
...
void XListCtrl::OnLButtonUp(UINT nFlags, CPoint point)
{
	...
	if( ( index = HitTestEx( point, &colnum )) != -1 )
	{
		...
		if( (GetItemState( index, flag ) & flag) == flag)
		{
			...
			if ((!pXLCD[colnum].bDateTime) &&	
				(!pXLCD[colnum].bCombo) &&
				(!pXLCD[colnum].bShowProgress) &&
				
				// Add check for LVS_EDITLABELS
				(GetWindowLong(m_hWnd, GWL_STYLE) & LVS_EDITLABELS)  &&
				
				(GetColumnWriteFlag(colnum)))
			{
...
int XListCtrl::HitTestRow(CPoint &point) const
{
...
int XListCtrl::HitTestEx(CPoint &point, int *col) const
{
	int colnum = 0;
	int row = HitTest( point, NULL );

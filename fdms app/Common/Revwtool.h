...
//	BOOL Review_Tool_GetCmdLineArgs(HINSTANCE hInstance, char *Args, UINT *puiNumArgs, char **paszCmdLineParms[]);
	BOOL Review_Tool_GetCmdLineArgs(HINSTANCE hInstance, CString &Args, UINT *puiNumArgs, char **paszCmdLineParms[]);
